            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <img
                    className="block h-8 w-24 lg:w-48  lg:hidden"
                    src={logo}
                    alt="Your Company"
                  />
                  <img
                    className="hidden h-8  w-24 lg:w-48 lg:block mr-"
                    src={logo}
                    alt="Your Company"
                  />
                </div>
            ...
            <div className="space-y-1 px-2 pt-2 pb-3 text-center">
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  className={classNames(
                    item.current ? 'text-purple-500 ' : 'text-gray-300 hover:text-purple-500',
                    'block px-3 py-2 rounded-md text-sm font-light ease-out duration-300'
                  )}
                  aria-current={item.current ? 'page' : undefined}
                >
                  {item.name}
